...
function Skill() {
  return (
    <div id='Skill' className='w-full h-fit'>
      ...
      <div className='w-40  rounded-2xl  h-40 place-content-center  justify-items-center shadow-md hover:shadow-2xl '>
      ...
      <div className='w-40   h-40 place-content-center  justify-items-center shadow-md hover:shadow-2xl  rounded-2xl'>
