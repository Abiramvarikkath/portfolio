  ...
  return (
    ...
    <div className='grid grid-cols-3 gap-3 flex text-center text-bold mt-12 p-10 '>
        <div >
          ...
          <SiFlipkart className='text-yellow-400 w-20 h-20 animate-pulse hover:animate-spin hover:cursor-pointer'/>
        ...
        <SiStarbucks className="text-green-700 w-20 h-20 animate-pulse  hover:animate-spin hover:cursor-pointer" />
        ...
        <div>
          <div className='bg-white object-center w-70 h-60 rounded-2xl shadow-xl flex flex-col items-center transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110  pt-10'>
            <SiKtm className=' text-orange-600 w-24 h-24 animate-pulse  hover:animate-spin hover:cursor-pointer'/>
